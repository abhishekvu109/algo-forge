...
class ArrayStackTest {
    ...
    void testPushUntilFull() {
        ArrayStack<Integer> smallStack = new ArrayStack<>(3);
        smallStack.push(1);
        smallStack.push(2);
        smallStack.push(3);
    ...
    void testPeekOnEmptyStack() {
        assertThrows(RuntimeException.class, stack::peek, "Stack is empty");
    }
    ...
    void testCustomCapacityStack() {
        ArrayStack<String> customStack = new ArrayStack<>(2);
        customStack.push("A");
        customStack.push("B");
